...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface Order {
      ...
      /**
       * The shipping method that is currently selected for this order, if any. If present, it is equal to one of the `id`s of shipping methods in the `shipping_methods` array. At order creation time, if th// File generated from our OpenAPI spec
