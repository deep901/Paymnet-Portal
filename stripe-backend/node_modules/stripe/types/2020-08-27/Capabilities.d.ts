  ...
  namespace Stripe {
    ...
    namespace Capability {
      interface Requirements {
        ...
        /**
         * The fields that need to be collected to keep the capability enabled. If not collected by the `current_deadline`, these fields appear in `past_due` as well, a// File generated from our OpenAPI spec
