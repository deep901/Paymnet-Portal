...
declare module 'stripe' {
  namespace Stripe {
    ...
    interface BalanceTransactionListParams extends PaginationParams {
      ...
      /**
       * Only return transactions in a certain currency. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must b// File generated from our OpenAPI spec
