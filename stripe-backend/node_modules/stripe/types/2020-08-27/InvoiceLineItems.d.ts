  ...
  namespace Stripe {
    ...
    namespace InvoiceLineItemListUpcomingParams {
      ...
      interface SubscriptionItem {
        ...
        /**
         * A list of [Tax Rate](https://stripe.com/docs/api/tax_rates) ids. These Tax Rates will override the [`default_tax_rates`](https://// File generated from our OpenAPI spec
