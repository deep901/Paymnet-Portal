declare const registryUrl: {
	...
	@param scope - Retrieve the registry URL associated with an [npm scope](https://docs.npmjs.com/misc/scope). If the provided scope is not in the user's `.npmrc` filedeclare const registryUrl: {
	/**
	Get the set npm registry URL.
